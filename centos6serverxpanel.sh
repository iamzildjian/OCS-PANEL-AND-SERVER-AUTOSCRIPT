...
read -p "Database Name    : " -e -i Sleak NamaDatabase
echo "Input MySQL Password:"
echo "(Use different Password for your database, dont use VPS password.)"
read -p "Database Password: " -e -i sleaker PasswordDatabase
echo ""
...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/iamzildjian/PanelxServer-Centos6/master/screenfetch"
chmod +x /usr/bin/screenfetch
echo "clear" >> .bash_profile
echo "screenfetch" >> .bash_profile

# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/iamzildjian/PanelxServer-Centos6/master/centos6/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/iamzildjian/PanelxServer-Centos6/master/centos6/1194-centos.conf"
if [ "$OS" == "x86_64" ]; then
  wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/iamzildjian/PanelxServer-Centos6/master/centos6/1194-centos64.conf"
fi
wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/iamzildjian/PanelxServer-Centos6/master/centos6/iptables.up.rules"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.githubusercontent.com/iamzildjian/PanelxServer-Centos6/master/centos6/open-vpn.conf"
sed -i $MYIP2 /etc/openvpn/1194-client.ovpn;
PASS=`cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 15 | head -n 1`;
useradd -M -s /bin/false Sleak
echo "Sleak:$PASS" | chpasswd
echo "Sleak" > pass.txt
echo "$PASS" >> pass.txt
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/iamzildjian/PanelxServer-Centos6/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/iamzildjian/PanelxServer-Centos6/master/badvpn-udpgw64"
fi
...
# setting banner
rm /etc/issue.net
wget -O /etc/issue.net "https://raw.githubusercontent.com/iamzildjian/PanelxServer-Centos6/master/issue.net"
...
# install mrtg
cd /etc/snmp/
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/iamzildjian/PanelxServer-Centos6/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/iamzildjian/PanelxServer-Centos6/master/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/iamzildjian/PanelxServer-Centos6/master/mrtg.conf" >> /etc/mrtg.cfg
...
# install vnstat gui
cd /home/vps/public_html/
wget https://raw.githubusercontent.com/iamzildjian/PanelxServer-Centos6/master/vnstat_php_frontend-1.5.1.tar.gz
...
# install stunnel
yum install stunnel
#wget -O /etc/pki/tls/certs/stunnel.pem "https://raw.githubusercontent.com/iamzildjian/PanelxServer-Centos6/master/updates/stunnel.pem"
#wget -O /etc/stunnel/stunnel.conf "https://raw.githubusercontent.com/iamzildjian/PanelxServer-Centos6/master/updates/stunnel.conf"
...
# download script
cd
wget https://raw.githubusercontent.com/iamzildjian/PanelxServer-Centos6/master/updates/install-premiumscripts.sh -O - -o /dev/null|sh
...
echo "Modified by Sleak"                      	                 	| tee -a log-install-ocspanel.txt
echo "--------------------------------------------------------------------------------"| tee -a log-install-ocspanel.txt
echo ""
echo ""
cd
